...
var _t = ~process.argv.indexOf('-t')
         ? Number(process.argv[process.argv.indexOf('-t')+1])
         : 2000
var _p = ~process.argv.indexOf('-p')
         ? Number(process.argv[process.argv.indexOf('-p')+1])
         : 553784
var _n = ~process.argv.indexOf('-n')
         ? Number(process.argv[process.argv.indexOf('-n')+1])
         : 1
var _i = ~process.argv.indexOf('-i')
         ? Number(process.argv[process.argv.indexOf('-i')+1])
         : 1000
